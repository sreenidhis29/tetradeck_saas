...
export default function HRAuthPage() {
    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col items-center justify-center p-4 overflow-hidden relative">
            ...
            {/* Background FX - Consistent with Landing */}
            ...
            <div className="max-w-4xl w-full text-center z-10">
                ...
                <div className="mb-8 flex flex-col items-center justify-center animate-fade-in-up">
                    <div className="p-4 bg-purple-500/20 rounded-2xl mb-4 border border-purple-500/30">
                        <ShieldCheck className="w-12 h-12 text-purple-400" />
                    </div>
                    <h1 className="text-5xl font-bold bg-gradient-to-br from-white via-purple-200 to-purple-400 bg-clip-text text-transparent mb-2">
                        HR Portal Access
                    </h1>
                    <p className="text-slate-400 max-w-lg mx-auto">
                        Secure gateway for Organization Administrators. Manage your workforce, payroll, and recruitment with enterprise-grade security.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mt-12">
                    ...
                    {/* Login Option */}
                    <Link href="/hr/sign-in" className="group">
                        <div className="h-full relative bg-white/5 border border-white/10 hover:border-purple-500 rounded-3xl p-8 transition-all duration-300 overflow-hidden hover:shadow-[0_0_40px_rgba(168,85,247,0.2)] flex flex-col items-center justify-between">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                <div className="w-16 h-16 rounded-2xl bg-purple-900/40 text-purple-300 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <UserCheck className="w-8 h-8" />
                                </div>
                                <h2 className="text-2xl font-bold text-white mb-2">Existing Admin</h2>
                                <p className="text-slate-400 text-sm mb-6">Log in to your account to access your company dashboard.</p>
                            </div>

                            <span className="relative z-10 w-full py-3 rounded-xl bg-white/10 border border-white/10 group-hover:bg-purple-600 group-hover:border-purple-500 text-white font-semibold transition-all flex items-center justify-center gap-2">
                    ...
                    {/* Register Option */}
                    <Link href="/hr/sign-up" className="group">
                        <div className="h-full relative bg-white/5 border border-white/10 hover:border-[#00f2ff] rounded-3xl p-8 transition-all duration-300 overflow-hidden hover:shadow-[0_0_40px_rgba(0,242,255,0.2)] flex flex-col items-center justify-between">
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                <div className="w-16 h-16 rounded-2xl bg-[#00f2ff]/10 text-[#00f2ff] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <UserPlus className="w-8 h-8" />
                                </div>
                                <h2 className="text-2xl font-bold text-white mb-2">New Organization</h2>
                                <p className="text-slate-400 text-sm mb-6">Register your company and set up your administrative account.</p>
                            </div>
