                ...
                <div className="relative z-10 w-full max-w-lg h-[600px]">
                    ...
                    <div className="absolute top-20 left-10 p-6 bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl animate-float-slow shadow-[0_0_30px_rgba(168,85,247,0.15)]">
                        <div className="flex items-center gap-3 text-purple-300">
                            ...
                            <span className="font-semibold text-white">AI Recruiting</span>
                        </div>
                    </div>

                    <div className="absolute top-40 right-10 p-6 bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl animate-float-medium delay-1000 shadow-[0_0_30px_rgba(0,242,255,0.15)]">
                        <div className="flex items-center gap-3 text-[#00f2ff]">
                            <div className="p-2 bg-[#00f2ff]/20 rounded-lg"><Shield className="w-5 h-5" /></div>
                            <span className="font-semibold text-white">Compliance</span>
                        </div>
                    </div>

                    <div className="absolute bottom-40 left-0 p-6 bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl animate-float-slow delay-2000 shadow-[0_0_30px_rgba(236,72,153,0.15)]">
                        <div className="flex items-center gap-3 text-pink-400">
                            <div className="p-2 bg-pink-500/20 rounded-lg"><Users className="w-5 h-5" /></div>
                            <span className="font-semibold text-white">Workforce</span>
                        </div>
                    </div>

                    <div className="absolute bottom-20 right-20 p-6 bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl animate-float-fast shadow-[0_0_30px_rgba(16,185,129,0.15)]">
                        <div className="flex items-center gap-3 text-emerald-400">
                            <div className="p-2 bg-emerald-500/20 rounded-lg"><Activity className="w-5 h-5" /></div>
